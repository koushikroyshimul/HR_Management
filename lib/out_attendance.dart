...
class OutAttendance extends StatefulWidget {
  const OutAttendance({Key? key}) : super(key: key);

  @override
  State<OutAttendance> createState() => _OutAttendanceState();
}

class _OutAttendanceState extends State<OutAttendance> {
        ...
        body: Center(
          child: Column(
            children: [
              ...
              SizedBox(height: 40,),
              Text("Daily Out Attendance", style: TextStyle(fontWeight: FontWeight.bold,color: Color(0xff022F40),fontSize: 30),),
              SizedBox(height: 5,),
              Padding(
